...
<body>
    ...
    ?>
				<form class="login100-form validate-form" action="" method="post">
					<span class="login100-form-title p-b-203" style="font-size: 25px;">SEMERU MOUNTAIN</span>
					...
					<div class="wrap-input100 validate-input m-b-20">
						<input id="first-name" class="input100" type="hidden" name="level" value="<?php echo "Admin"; ?>">
						<span class="focus-input100"></span>
					</div>
					<div class="container-login100-form-btn">
						<input type="submit" class="login100-form-btn" name="submit" value="SignIn">
					</div>
				...
				<div class="login100-more" style="background-image: url('images/semeru.jpg');"></div>
			</div>
		</div>
	</div>
